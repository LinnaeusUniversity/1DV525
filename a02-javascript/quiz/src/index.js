...
<link rel="stylesheet" href="css/style.css">
  ...
  <i class="question circle icon"></i>JavaScript Quiz Challenge
  <i  id="quizAppTerminate"></i>
  </aside>
...
class Quiz extends window.HTMLElement {
  ...
  /**
   * Whatever the user inputs as their name
   */
  ...
  // will be displayed
  // or if you loose then you will also get a message that you lost
